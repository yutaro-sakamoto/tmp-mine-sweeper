...
(function($PS) {
  ...
  var CellClose = (function () {
      ...
      CellClose.value = new CellClose();
      return CellClose;
  })();
  var CellClick = (function () {
      function CellClick(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CellClick.create = function (value0) {
          return function (value1) {
              return new CellClick(value0, value1);
          };
      };
      return CellClick;
  })();
  var renderCell = function (cell) {
      return function (x) {
          return function (y) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Events.onClick(function (v) {
                  return new CellClick(x, y);
                  ...
                  throw new Error("Failed pattern match at Main (line 110, column 3 - line 115, column 19): " + [ cell.appearance.constructor.name ]);
              })()) ]);
          };
      };
  };
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Mine Sweeper") ]), Halogen_HTML_Elements.div_([ renderBoard(state.board) ]) ]);
  };
  ...
  var openCell = function (x) {
      return function (y) {
          return function (board) {
              return modifyBoardAt(x)(y)(board)(function (cell) {
                  return {
                      appearance: CellOpen.value,
                      arroundBomb: cell.arroundBomb,
  ...
  var initialCell = {
      appearance: CellClose.value,
      arroundBomb: 0,
      hasBomb: false
  };
  var makeInitialBoard = function (config) {
      return Data_Array.replicate(config.boardWidth)(Data_Array.replicate(config.boardHeight)(initialCell));
  };
      ...
      return function (x) {
          return function (y) {
              return function (board) {
                  ...
                  var r = Data_Array.range(n)((config.boardWidth * config.boardHeight | 0) - 1 | 0);
                  var l = Data_Array.range(0)(n - 2 | 0);
                  var xs = Data_Array.concat([ l, r ]);
                  return function __do() {
                      var ys = generateRandomArray(config.numberOfBombs)(xs)();
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (state.start) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                          ...
                          $26.board = openCell(v.value0)(v.value1)(state.board);
                          return $26;
                      })());
                  };
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(spreadBombs(state.config)(v.value0)(v.value1)(state.board)))(function (newBoard) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                          var $29 = {};
                          for (var $30 in state) {
                          ...
                          $29.board = openCell(v.value0)(v.value1)(newBoard);
                          $29.start = true;
                          return $29;
                      })());
                  });
